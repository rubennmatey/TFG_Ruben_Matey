    ...
    for uid, alias, role, active in sample_credentials:
        try:
            ...
            try:
                ...
                print(f"Credencial inicial registrada en blockchain: {result}")

            except Exception as e:
                print(f"ERROR registrando credencial inicial en blockchain {uid}: {e}")

        except sqlite3.IntegrityError:
            print(f"La credencial ya existe en SQLite, no se vuelve a crear: {uid}")
